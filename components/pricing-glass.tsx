    ...
    >
      {tier.isPopular && (
        <>
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-x-0 top-0 h-px overflow-hidden rounded-t-[1.75rem] bg-electric/20"
          >
            <motion.span
              className="absolute inset-y-0 left-0 w-1/3 bg-gradient-to-r from-transparent via-[#b9c7ff] to-transparent shadow-[0_0_12px_2px_rgba(117,145,255,0.7)]"
