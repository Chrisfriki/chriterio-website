  ...
  return (
    ...
    >
      <div className="sticky top-0 h-[100svh] min-h-[640px] w-full overflow-hidden bg-[#050d1f]">
        ...
        <div className="absolute inset-x-0 top-1/2 z-10 flex -translate-y-1/2 flex-col items-center gap-6 px-6 text-center sm:top-0 sm:translate-y-0 sm:px-8 sm:pt-[clamp(6.5rem,15svh,8rem)] md:gap-10 md:pt-[18svh]">
