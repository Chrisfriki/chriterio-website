...
export function SiteNavbar() {
  ...
  useEffect(() => {
    ...
    // The homepage hero can be a scroll-driven section (e.g. the
    ...
    // actually scrolled past, however tall it is. The navbar itself is
    // always visible — only its background/text color reacts to scroll.
